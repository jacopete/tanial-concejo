...
router.get('/',logeousuario,async(req, res)=>{  
  ...
  numero=conteo[0].numero;
   ...
   res.render('personalvista/personalvista',{usuario,navegacion,tipo,comuna,zona,puesto,numero});
  ...
  // queryy += '  ' 
   ...
   res.render('personalvista/personalvista',{usuario,page,navegacion,tipo,comuna,zona,puesto,numero});
       ...
       if(cedula==''){
          ...
          console.log(req.body);
           ...
           const usuario = await pool.query('SELECT * FROM gestores WHERE cedula='+cedula);
            ...
            res.render('personalvista/cedula',{usuario });
  ...
  router.get('/lista/:cedula',logeousuario,async(req, res)=>{  
    ...
    if(verificausuario[0].tipo=="LIDER ESTRUCTURA" ||verificausuario[0].tipo=="LIDER INDEPENDIENTE" ||verificausuario[0].tipo=="FUNCIONARIO"||(verificausuario[0].tipo=="GESTOR" && verificausuario[0].reporte!=0)){
      ...
      res.render('personalvista/lista',{usuario,numero,vista,verificausuario});
    }else{
         ...
         usuariolista  =await pool.query(query);
         vista=false;
         res.render('personalvista/lista',{usuario,vista,numero,verificausuario});
      ...
      router.get('/lista1/:cedula',logeousuario,async(req, res)=>{  
        const {cedula} = req.params;
        const items=5;
        const page = req.body.page|| 1;
        var vista;
...
res.render('personalvista/lista1',{usuario,vista,numero,verificausuario,reportecomuna,numerototal,reportecomunatotal,
...
const textomostrar=true;
      ...
      router.get('/listagestor/:cedula',logeousuario,async(req, res)=>{  
        const {cedula} = req.params;
        //const {cedula} = req.body;
    ...
    // si existe el interrogante
        ...
        if(verificausuario[0].tipo=="LIDER ESTRUCTURA" ||verificausuario[0].tipo=="LIDER INDEPENDIENTE" ||verificausuario[0].tipo=="FUNCIONARIO"||verificausuario[0].tipo=="GESTOR"){
          ...
          console.log(cedulagestor);
           res.render('personalvista/listagestor',{usuario,numero,vista,verificausuario,cedulagestor});
        }
        
        });
  router.get('/descargalistalf',logeousuario,function(req, res){
